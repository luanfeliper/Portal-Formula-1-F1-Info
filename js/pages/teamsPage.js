...
import { createTeamCards, renderTeamsHero } from '../modules/teams.js'; // Renderiza o HTML
...
async function init() {
    ...
    try {
        ...
        // Repassamos os dados
        if (drivers && teams) {
            createTeamCards(teams, drivers);
        }

    } catch (error) {
        console.error("Erro ao inicializar página de equipes:", error);
    }
}
